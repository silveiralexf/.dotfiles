...
return {
  ...
  config = function()
    ...
    if not dap_ok or not dap then return end
    ...
    if dapui and dapui.open and dapui.close then
      local open, close = function() dapui.open({}) end, function() dapui.close({}) end
    ...
    vim.keymap.set('n', '<leader>du', function() pcall(require('dapui').toggle, {}) end, { desc = '[d]ap [u]i' })
    vim.keymap.set('n', '<leader>de', function() pcall(require('dapui').eval) end, { desc = '[d]ap [e]val' })
    vim.keymap.set('n', '<leader>db', function() require('dap').toggle_breakpoint() end, { desc = 'toggle [d]ebug [b]reakpoint' })
    ...
    vim.keymap.set('n', '<leader>di', function() require('dap').step_into() end, { desc = '[d]ebug [i]nto' })
    ...
    vim.keymap.set('n', '<leader>dh', function() require('dap').step_back() end, { desc = '[d]ebug step back [h]' })
    vim.keymap.set('n', '<leader>dx', function() require('dap').restart() end, { desc = '[d]ebug restart [x]' })
    vim.keymap.set('n', '<leader>dC', function() require('dap').run_to_cursor() end, { desc = '[d]ebug [C]ursor' })
    vim.keymap.set('n', '<leader>dg', function() require('dap').goto_() end, { desc = '[d]ebug [g]o to line' })
    vim.keymap.set('n', '<leader>dj', function() require('dap').down() end, { desc = '[d]ebug [j]ump down' })
    vim.keymap.set('n', '<leader>dk', function() require('dap').up() end, { desc = '[d]ebug [k]ump up' })
    ...
    vim.keymap.set('n', '<leader>dr', function() require('dap').repl.toggle() end, { desc = '[d]ebug [r]epl' })
    vim.keymap.set('n', '<leader>dR', function() require('dap').clear_breakpoints() end, { desc = '[d]ebug [R]emove breakpoints' })
    ...
    vim.keymap.set('n', '<leader>dw', function() pcall(require('dap.ui.widgets').hover) end, { desc = '[d]ebug [w]idgets' })
  end,
}
