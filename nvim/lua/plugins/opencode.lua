...
return {
  ...
  config = function()
    ...
    vim.keymap.set('n', '<leader>or', function()
      opencode.prompt('Review @file for correctness and readability')
    end, { desc = 'Review file' })
    vim.keymap.set('n', '<leader>of', function()
      opencode.prompt('Fix these @diagnostics')
    end, { desc = 'Fix errors' })
    vim.keymap.set('v', '<leader>od', function()
      opencode.prompt('Add documentation comments for @selection')
    end, { desc = 'Document selection' })
    vim.keymap.set('v', '<leader>ot', function()
      opencode.prompt('Add tests for @selection')
