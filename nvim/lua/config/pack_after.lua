...
local function run_plugin_configs()
  ...
  local order = {
    'luarocks', 'colorscheme', 'yazi', 'fzf', 'git', 'lsp',
    'dressing', 'noice', 'lualine', 'treesitter', 'conform',
    'editor', 'indent', 'trouble', 'tmux', 'luasnip',
    'nvim-nio', 'formatting', 'lazydev', 'go', 'neotest',
    'cloak', 'cursoragent', 'kcl', 'matchup', 'mini', 'modelmate',
    'opencode', 'quickfix', 'sops', 'undotree', 'wakatime', 'yaml-companion', 'zig',
  }
  local seen = {}
